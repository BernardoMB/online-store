...
import { Text, Box, Flex, Icon, Stack, Image, Button, AspectRatio, Select, Portal, Spacer } from "@chakra-ui/react";
...
const ProductCardSmall: React.FC<ProductCardProps> = ({
    ...
    const [selectedSize, setSelectedSize] = useState<string | undefined>("8");
