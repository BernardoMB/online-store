                ...
                <Stack gap={{ base: '1rem', md: '3rem'}}>
                    <Stack gap='2rem'>
                        <Stack flexDirection={'column'} gap='1rem'>
                            ...
                            <Text as='p' color={'#5D5D58'} fontSize={'1.125rem'} lineHeight={'1.75rem'} whiteSpace={'pre-line'} textAlign={{base: 'center', md: 'start'}}>Crystal, stone, and glow powder—fused in harmony to craft a luminous masterpiece.</Text>
                        </Stack>
                    </Stack>
